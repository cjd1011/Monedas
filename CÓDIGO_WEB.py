...
elegir_columnas = ['Nemotecnico', 'fecha', 'Precio Cierre', 'RSI', 'EMA14', 'EMA50', 'EMA200','MACD_Line', 'Signal_Line','Histograma']
...
Activo2 = st.multiselect(
    "Seleccione el Activo:",
    options=df2['Indicador'].unique(),
    default=['MACD_Line', 'Signal_Line','Histograma']  # Por default, seleccionamos todas las medias móviles y el precio
)

df_seleccion2 = df2.query("Indicador == @Activo2")  # el primero es la columna y el segundo es el selector

fig2 = px.line(x='fecha', y='valor', title='Gráfica MACD', data_frame=df_seleccion2, color='Indicador')
